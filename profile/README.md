...
Open source AI workflow engine. Automate any AI from a simple YAML file — any provider, parallel execution, structured output. Single Rust binary, zero dependencies.
...
Your digital identity. Beautiful, customizable micro-sites. Consumer-first.
...
We make consumer products — apps, tools, platforms — that we'd want to use ourselves.
